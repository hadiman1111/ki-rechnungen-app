...
| 34 | `KI_RECHNUNGEN_TRACK_B_SAAS_READINESS_FINAL_AUDIT_AND_MANUAL_SMOKE_01` | AUDIT READY / SMOKE PENDING | _(this task commit)_ | `TRACK_B_INTERNAL_PILOT_READY_WITH_MANUAL_SMOKE_PENDING_NOT_SAAS_READY` | Manual smoke `NOT_RUN`; not SaaS-ready |
